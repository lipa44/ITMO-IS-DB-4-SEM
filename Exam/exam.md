...
2. Выделение контцра обеспечения безопасности
...
1. Журнал контроля доступа к системе (журналируются действия пользователя)
2. Изоляция ресурсов - при выделении объекта из негоко пула ресурсов доверенной вычислительной базы за тем удаляются следы его использования
...
**Фрейм** - структура для описания стереотипной ситуации. Сотоит из некоторых характеристик этой ситуации (слотов) и их значений.
